...
#define APP_BUTTON_ADV_TIME_S					10
...
#define SLAVE_LATENCY_DEFAULT                   3//4//2//1  //(alteracao 12-09-16)                                         /**< Slave latency (in number of connection events that peripheral can get delayed) // By setting a non-zero slave latency, the Peripheral can choose to not answer when the Central asks for data up to the slave latency number of times.*/
