...
//#ifdef DEV_KIT
//#define PWM_PIN_LOGIC			1						//0-L�gica n�o invertida 1-Para l�gica invertida
//#else
#define PWM_PIN_LOGIC			0						//0-L�gica n�o invertida 1-Para l�gica invertida
//#endif
...
#define PWM_IRQ_PRIORITY        APP_IRQ_PRIORITY_LOW
...
void apply_pan73_workaround(NRF_TIMER_Type *timer, bool enable);
#endif
